								...
								<div>
									<ul class="ace-thumbnails clearfix">
										...
										<li>
											<?= $this->tag->linkTo(['/uploaded/' . $item->uri, $this->tag->image(['/uploaded/' . $item->uri, 'alt' => $item->tag, 'height' => '150', 'width' => '150']), 'target' => '_blank']) ?>
									...
									<div class="search-area text-center">
										<ul class="pagination">
											...
											<?php } else { ?>
											<li>
												<?= $this->tag->linkTo(['/management/gallery?page=' . $page->before, '<i class="ace-icon fa fa-angle-double-left"></i>']) ?>
											</li>
											<?php } ?>
											...
											<?php } else { ?>
											<li>
												<?= $this->tag->linkTo(['/management/gallery?page=' . $page->next, '<i class="ace-icon fa fa-angle-double-right"></i>']) ?>
											</li>
											<?php } ?>
										</ul>
									</div>
