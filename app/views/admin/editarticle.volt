									...
									<div class="row">
										<div class="col-xs-8" role="form">
											<div class="form-group">
												...
												<div class="col-sm-9">
													{{ forms.render('title', ['value': article.title]) }}
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="management-add-title"> Relative URI </label>

												<div class="col-sm-9">
													{{ forms.render('slug', ['value': article.slug]) }}
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="management-add-title"> Description </label>

												<div class="col-sm-9">
													{{ forms.render('description', ['value': article.description]) }}
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="management-add-title"> Tag </label>

												<div class="col-sm-9">
													<span class="input-icon">
														{{ forms.render('tag', ['value': article.tag]) }}
														<i class="ace-icon fa fa-tag blue"></i>
													</span>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="management-add-title"> Category </label>

												<div class="col-sm-9">
													{{ forms.render('category', ['value': article.category]) }}
												</div>
											</div>
										</div>
										<div class="col-xs-4">
											...
											<label class="control-label no-padding-right"> Current( Click form above to change)</label>
											<div class="widget-main no-padding txtcen">
												{% if article.intro is defined %}
													{{ image('/uploaded/'~article.intro, 'class': 'middle wh200p imgcustom') }}
												{% else %}
													{{ image('/uploaded/default.png', 'class': 'middle wh200p imgcustom') }}
												{% endif %}
											</div>
										</div>
									</div>
