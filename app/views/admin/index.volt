												...
												<div class="widget-main no-padding">
													...
													<div class="dialogs">
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																{{ image('/img/avatar5.png', 'alt': 'Tadashi same s avatar') }}
															</div>
															...
															<div class="body">
																...
																<div class="tools">
																	{{ link_to('/management/list-articles/'~work.id, '<i class="icon-only ace-icon fa fa-share"></i>', 'class': 'btn btn-minier btn-info', 'title': 'Edit this') }}
																</div>
															</div>
														</div>
														{% endfor %}
